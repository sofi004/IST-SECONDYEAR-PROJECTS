...
{ 
  ...
  tutorial = createDiv("Os 6 círculos no centro, têm as 2 primeiras letras da palavra.<br/>Passe o rato por cima deles para acessar as cidades.<br/>Os circulos azuis que aparecem à volta estão agrupados pela<br/>terceira letra da palavra e por ordem alfabética.<br/>À frente dos grupos escrevemos as 3 iniciais da palavra.<br/>Para melhor experiência ponha som.<br/>Saiba que o tempo só começa a contar depois de carregar<br/>na primeira cidade, por isso aproveite o início para<br/>se acostumar com a UI.");
  tutorial.id('main_text');
  tutorial.position(10, 150);
